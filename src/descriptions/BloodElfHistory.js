...
const BloodElfHistory = props => {
    return (
        <div>
        	<h3>Blood Elf History</h3>
        	<div>
...
At the bidding of his new master, the wayward prince eventually returned to Azeroth and seized the site of the Sunwell, hoping to use the fount as a means to usher Kil’jaeden into the world. Ultimately, Kael’thas was slain before his recklessness could bring ruin to Azeroth.
        	</div>
        </div>
    )
}

export default BloodElfHistory
